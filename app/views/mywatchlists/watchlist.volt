<div class="clearfix">
	<div class="search-on-etsy">
		...
		<div class="search-on-etsy-results">
			...
			<a href="?offset={{ (offset + 1) }}&pageSize=32" class="button load-more" data-item-selector=".search-on-etsy-results .listing" data-page-size="32" data-item-wrapper-selector=".search-on-etsy-results ul" data-item-callback="app.myWatchlists.getListingMarkup" data-url="">Show more</a>
			{% endif %}
		</div>
	</div>
